...
class DatabaseConnection {
    ...
    select(columns) {
        ...
        this.queryBuilder = Object.assign(Object.assign({}, this.queryBuilder), attributes);
        return this;
    }
    where(column, value, condition = "=") {
        let keyCondition = this.conditionals[condition][0];
        if ("where" in this.queryBuilder) {
            (this.queryBuilder).where = Object.assign(Object.assign({}, this.queryBuilder.where), { [keyCondition]: [
                    { [column]: value }
                ] });
        }
        let where = {
        ...
        this.queryBuilder = Object.assign(Object.assign({}, this.queryBuilder), where);
        return this;
    }
